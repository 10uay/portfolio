...
export type ProjectsProps = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Projects = (props: ProjectsProps) => {
  ...
  return (
    <section className="px-[5%] py-16 md:py-24 lg:py-36">
      <div className="container">
        <div className="mb-12 w-full max-w-lg md:mb-18 lg:mb-20 text-center lg:text-start">
  ...
  return (
    ...
    >
      ...
      <CardContent
        ...
        transition={{ duration: 0.3, ease: "easeInOut" }}
      >
        <div className="flex h-full flex-col px-6 pb-8 pt-4 md:px-10 md:pb-12 md:pt-12 lg:w-[40rem] lg:px-12 lg:pb-16 lg:pt-16 text-center">
...
export const ProjectsDefaults: ProjectsProps = {
  tagline: "Projects",
